 ...
 * @param {Object}
 */
export const useState = (store: any, namespace: string, states: Array<string> | object): ComputedRef => {
  const res: any = {}
 ...
 * @return {Object}
 */
export const useGetters = (store: any, namespace: string, getters: Array<string> | object): ComputedRef => {
  const res: any = {}
